...
interface ClientTwoProps {
  theme?: "orange" | "navy";
}

const ClientTwo = ({ theme = "navy" }: ClientTwoProps) => {
  const settings = {
    infinite: true,
    slidesToShow: 5,
    slidesToScroll: 1,
  ...
  return (
    ...
    >
      <div className="container">
        ...
        <div
          className={`subscribe-area-4 ${theme === "navy" ? "navy-theme" : ""}`}
          style={
            theme === "orange"
              ? { backgroundImage: "url('/assets/img/bg/subscribe-bg4-1.png')" }
              : undefined
          }
        >
